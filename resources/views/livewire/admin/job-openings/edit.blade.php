...
new class extends Component {
    ...
    public function mount(JobOpening $jobOpening): void
    {
        ...
        $this->is_active = $jobOpening->is_active;
    }
    ...
    public function save()
    {
        ...
        $this->jobOpening->update($validated);
...
<div>
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Admin / Carrières /</span> Modifier
    </h4>

    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Modifier l'Offre d'Emploi</h5>
        </div>
        <div class="card-body">
