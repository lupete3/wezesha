...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        session()->flash('status', 'Compétence ajoutée avec succès.');
...
<div>
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Admin / Expertise /</span> Ajouter
    </h4>
        ...
        <div class="card-body">
            <form wire:submit="save">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="title" wire:model="title" placeholder="Ex: Audit & Commissariat">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="description" wire:model="description" placeholder="Ex: Rigueur et indépendance">
