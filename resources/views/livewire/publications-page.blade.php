            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item categories">
                <ul>
                  ...
                  <li><a href="{{ route('publications', 'guides') }}" class="{{ $category == 'guides' ? 'active' : '' }}">Guides Fiscaux <span>({{ \App\Models\Publication::where('category', 'guides')->count() }})</span></a></li>
                  <li><a href="{{ route('publications', 'ohada') }}" class="{{ $category == 'ohada' ? 'active' : '' }}">Notes OHADA <span>({{ \App\Models\Publication::where('category', 'ohada')->count() }})</span></a></li>
